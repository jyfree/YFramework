...
import jy.cn.com.yframework.simple.social.ext.pay.ExtPay
import jy.cn.com.yframework.simple.social.ext.pay.SDKPayManager
 ...
 * @TODO
 */
class ExtPaySimpleActivity : BaseActivity() {

    companion object {
        fun startAct(context: Context) {
            ActivityUtils.startActivity(context, ExtPaySimpleActivity::class.java)
        }
    }
