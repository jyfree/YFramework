...
public class NetworkUtil {
    ...
    public static String getNetworkTypeName() {
        ...
        try {
            ConnectivityManager mgr = (ConnectivityManager) BaseApplication.getInstance().getApplicationContext()
    ...
    public static boolean isWifiNetWork() {
        try {
            ...
            ConnectivityManager connectMgr = (ConnectivityManager) BaseApplication.getInstance().getApplicationContext()
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            if (null == connectMgr) {
                return false;
            }
