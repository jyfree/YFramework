package jy.cn.com.ylibrary.widget;
...
//            mOnDismissListener = null;
    ...
    public static int[] calculatePopWindowPos(final View anchorView, final View contentView) {
        ...
        // 获取屏幕的高宽
        final int screenHeight = ScreenResolution.getResolution(anchorView.getContext()).second;
        final int screenWidth = ScreenResolution.getResolution(anchorView.getContext()).first;
