...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(String packageName, String className) {
        ...
        return !(BaseApplication.getInstance().getApplicationContext().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(BaseApplication.getInstance().getApplicationContext().getPackageManager()) == null ||
                BaseApplication.getInstance().getApplicationContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(String pkg, String cls) {
        startActivity(BaseApplication.getInstance().getApplicationContext(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(Bundle extras, String pkg, String cls) {
        startActivity(BaseApplication.getInstance().getApplicationContext(), extras, pkg, cls, extras);
    }
    ...
    public static void startActivity(String pkg, String cls, Bundle options) {
        startActivity(BaseApplication.getInstance().getApplicationContext(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(Bundle extras, String pkg, String cls, Bundle options) {
        startActivity(BaseApplication.getInstance().getApplicationContext(), extras, pkg, cls, options);
    }
