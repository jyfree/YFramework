    ...
    companion object DownHandler : Handler() {
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (msg.arg1 >= 0 && msg.arg2 > 0) {
                YLogUtil.iTag("DownloadManager", "current progress is ${msg.arg1 / msg.arg2.toFloat()}")
            }
        }
    }
...
//                setNotificationVisibility(DownloadManager.Request.VISIBILITY_HIDDEN)
            ...
            if (isSavePoint) {
                ...
                if (downloadId != 0L) {
                    when (getDownloadStatus(downloadId)) {
                        ...
                        DownloadManager.STATUS_RUNNING -> YLogUtil.eTag("DownloadManager", "download is running")
    ...
    private fun addDownloadEnqueueAndSaveId(index: Int, request: DownloadManager.Request, url: String) {
        downloadIds[index] = downloadManager.enqueue(request)
        YLogUtil.iTag("DownloadManager", "put download id", "$url :: ${downloadIds[index]}")
